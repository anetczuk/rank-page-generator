...
packages_list = find_packages(include=["rankpagegenerator", "rankpagegenerator.*"])

## additional data to install
packages_data: Dict[str, Any] = {"rankpagegenerator": []}
